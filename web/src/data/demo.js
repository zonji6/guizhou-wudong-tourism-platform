...
const missingImageAlt = category => `乌东${categories.find(item => item.id === category)?.label || '服务'}实景暂缺`
export const services = [
  { id: serviceId(1), category: 'culture', title: '苗寨古茶园 · 制茶品茗体验', price: 168, image: local('tea'), imageAlt: '茶园里正在采茶的人', tags: ['苗族文化', '手作制茶', '半日'], intro: '走进云雾茶园，跟着寨中茶师采青、杀青、品一盏春茶。', demoData: true },
  { id: serviceId(2), category: 'culture', title: '山茶待客 · 采茶体验', price: 128, image: local('tea'), imageAlt: '茶园里正在采茶的人', tags: ['采茶', '品茗', '半日'], intro: '循着茶香认识采茶、制茶和递茶的日常。', demoData: true },
...
export const demoAssistantCard = { type: 'itinerary', title: '苗族文化茶旅 · 示例行程', summary: '这是用户主动开启的演示结果，请以服务方确认结果为准。', data: { demoMode: true, retrievalMode: 'keyword_demo', days: [{ title: '第一天', items: [{ title: '古茶园采茶与制茶品茗', serviceId: services[0].id, demoData: true }] }, { title: '第二天', items: [{ title: '山茶待客与品茗体验', serviceId: services[1].id, demoData: true }] }] }, sources: [{ title: '乌东古茶园体验指南', document_id: 'wudong-tea-guide-demo' }], demoData: true }

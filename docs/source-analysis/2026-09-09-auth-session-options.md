...
2026-09-09。仅技术选型，推荐尚未获用户批准，也未实现。讨论前提：Vue Web、原生微信小程序、Java 业务层、已选 Redis；现有 Spring Boot 3.4.2 / Java 21。
...
待用户确认：是否采用 Spring Security + Spring Session Redis 作为首版登录会话方案？
